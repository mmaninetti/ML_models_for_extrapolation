...
label <- paste0("TABLES/table_results_accuracy_only_num_features_EP_VS_IP")
...
caption <- paste0("Average relative difference of test accuracy using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_accuracy_clustering_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test accuracy using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_accuracy_umap_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test accuracy using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_accuracy_spatial_depth_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test accuracy using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_accuracy_mahalanobis_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
