...
caption <- paste0("Average test logloss. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
                   #Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_logloss_mahalanobis")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average test logloss. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
                   #Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_logloss_spatial_depth")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average test logloss. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
                   #Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_logloss_clustering")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average test logloss. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
                   #Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_logloss_umap")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
for (task_id in task_ids)
{
  ...
  for (directory in list_directories)
  {
    ...
    filename <- file.path(directory, paste0(task_id, "_random_logloss_results.csv"))
...
caption <- paste0("Average test logloss. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_logloss_random_splits")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
