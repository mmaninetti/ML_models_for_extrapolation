...
label <- paste0("TABLES/table_results_RMSE_only_num_features_EP_VS_IP")
...
caption <- paste0("Average relative difference of test RMSE using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_RMSE_clustering_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test RMSE using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_RMSE_umap_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test RMSE using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_RMSE_spatial_depth_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test RMSE using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_RMSE_mahalanobis_only_num_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
