...
for task_id in benchmark_suite.tasks:
    ...
    if task_id == 361096 or task_id == 361287 or task_id == 361292:
        continue
    ...
    df = pd.read_csv(f'RESULTS/RANDOM/{task_id}_random_crps_results.csv')
    ...
    df.to_csv(f'RESULTS/RANDOM/{task_id}_random_crps_results.csv', index=False)