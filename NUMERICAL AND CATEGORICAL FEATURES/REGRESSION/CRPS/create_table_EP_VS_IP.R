...
label <- paste0("TABLES/table_results_CRPS_num_and_cat_features_EP_VS_IP")
...
caption <- paste0("Average relative difference of test CRPS using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_CRPS_gower_num_and_cat_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test CRPS using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_CRPS_clustering_num_and_cat_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average relative difference of test CRPS using EP VS using IP, in \\%. 
                  ...
                  'Median diff.' denotes the median of each column.")
#Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_CRPS_umap_num_and_cat_features_EP_VS_IP")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
