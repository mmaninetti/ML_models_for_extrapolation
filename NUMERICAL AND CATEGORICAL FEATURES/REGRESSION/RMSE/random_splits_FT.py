...
for task_id in benchmark_suite.tasks:
    ...
    RMSE_FTTrans=torch.sqrt(torch.mean(torch.square(y_test_tensor - y_test_hat_FTTrans))).item()
    ...
    df = pd.read_csv(f'RESULTS/RANDOM/{task_id}_random_RMSE_results.csv')
    ...
    df.to_csv(f'RESULTS/RANDOM/{task_id}_random_RMSE_results.csv', index=False)
