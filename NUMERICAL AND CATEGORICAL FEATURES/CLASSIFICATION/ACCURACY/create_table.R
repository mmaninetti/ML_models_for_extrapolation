...
label <- paste0("TABLES/table_results_Accuracy_num_and_cat_features")
...
caption <- paste0("Average test Accuracy. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
                   #Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_Accuracy_gower_num_and_cat_features")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average test Accuracy. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
                   #Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_Accuracy_clustering_num_and_cat_features")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
...
caption <- paste0("Average test Accuracy. 
                  ...
                  'Avg. rank' denotes the average rank of a method.")
                   #Bold results are non-inferior to the best result in a paired t-test at a 5\\% level.
label <- paste0("TABLES/table_results_Accuracy_umap_num_and_cat_features")
filename <- paste0(label, ".tex", sep="")
tab <- xtable(output, caption = caption, label = label)
